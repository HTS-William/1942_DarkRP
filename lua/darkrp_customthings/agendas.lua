...
DarkRP.createAgenda("Reich Orders",
    { TEAM_FUHRER, TEAM_WEHR_OFFIZIER, TEAM_SS_OFFIZIER, TEAM_WSS_OFFIZIER },
    {
        ...
        TEAM_WSS_RECRUIT, TEAM_WSS_RIFLEMAN, TEAM_WSS_MEDIC, TEAM_WSS_MG, TEAM_WSS_NCO, TEAM_1ST_SS,
        TEAM_SS_RECRUIT, TEAM_SS_RIFLEMAN, TEAM_SS_MEDIC, TEAM_SS_SHARPSHOOTER, TEAM_SS_NCO, TEAM_GESTAPO,
